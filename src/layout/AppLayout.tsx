      ...
      <main className="w-11/12 m-auto h-full">
        <div className="flex space-x-10">
          ...
          <aside className="py-4 w-1/4 ">
            ...
            <li className="list-none">
              <NavLink to="/eventos" className={({ isActive }) => isActive ? "py-2 ml-9 bg-gray-300 rounded-md px-3 w-full block font-semibold" : "py-2 ml-9 rounded-md px-3 w-full block font-semibold"}>
                Eventos
              </NavLink>
            </li>
          </aside>
